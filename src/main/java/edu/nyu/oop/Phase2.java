...
public class Phase2 {
    ...
    public static Node buildCppAst(ObjectRepList ObjectRepList) {
        ...
        Node forwardDeclaration = GNode.create("ForwardDeclarations");
    ...
    public static Node buildClassNode(ObjectRep rep) {
        ...
        Node vfielddec = GNode.create("VFieldDec");

        Node datalayout = GNode.create("DataLayout",fields, constructors, methods, vfielddec );
    ...
    public static Node buildVTableNode(ArrayList<Field> vfields, ArrayList<VMethod> vmethods, String name) {
        ...
        root.add(name);
        Node vFields = GNode.create("VFields");
        for (Field vfield : vfields) {
        ...
        root.add(vFields);
        Node vMethods = GNode.create("VMethods");
        for(VMethod vmethod : vmethods) {
    ...
    public static class Phase2Visitor extends Visitor {
        ...
        public void visitConstructorDeclaration(GNode n) {
            ...
            Iterator parameters_iter = n.getNode(3).iterator();
